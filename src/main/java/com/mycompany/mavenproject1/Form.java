...
public class Form extends javax.swing.JFrame {
    ...
    private void submit() {
       ...
       User.add(Obj1);
       System.out.println("submit button: "+User.toString());
       addRowTable();
    ...
    private void updateForm() {
        ...
        User.set(u, new User(namet.getText(),emailt.getText(),schoolt.getText(),Integer.parseInt(aget.getText()),gendert.getText()));
